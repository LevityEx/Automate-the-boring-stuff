...
class MyZombie:
    ...
    def turn(self, gameState):
        ...
        initialRolls = random.randint(1,4) #initial rolls intended
        ...
        while diceRollResults is not None:
            ...
            #if within initial rolls
            if(rolls < initialRolls):
                #if rolled 2 shotguns
                if(not shotguns >= 2):
...
zombies = (
    ...
    MyZombie(name='Decide to stop after 1st roll'),
